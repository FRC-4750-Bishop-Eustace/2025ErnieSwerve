...
class SwerveModule:
    def __init__(
        ...
        self.driveMotor.configure(self.driveConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters)
        self.turningConfig = SparkMaxConfig()
        self.turningConfig.inverted(True)
        self.turningMotor.configure(self.turningConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters)
