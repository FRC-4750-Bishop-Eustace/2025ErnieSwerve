...
kModuleMaxAngularVelocity = math.pi * 10 #need to understand how this applies to the motor
kModuleMaxAngularAcceleration = math.tau * 10 #need to understand how this applies to the motor
...
class SwerveModule:
    def __init__(
        ...
        #self.driveConfig.encoder.positionConversionFactor((WheelRadius * (4 * math.pi)) / kDriveReduction)
    ...
    def setDesiredState(
        ...
        turnOutput = self.turningPIDController.calculate(
            self.turningEncoder.get_position(), state.angle.radians() 
        )
